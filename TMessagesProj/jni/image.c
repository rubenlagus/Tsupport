...
JNIEXPORT void Java_org_tsupport_messenger_Utilities_blurBitmap(JNIEnv *env, jclass class, jobject bitmap, int width, int height, int stride) {
    void *pixels = 0;
...
JNIEXPORT void Java_org_tsupport_messenger_Utilities_loadBitmap(JNIEnv *env, jclass class, jstring path, jintArray bitmap, int scale, int format, int width, int height) {
