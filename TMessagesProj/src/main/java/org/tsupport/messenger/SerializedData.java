...
public class SerializedData extends AbsSerializedData {
    ...
    private void writeInt32(int x, DataOutputStream out) {
        try {
            ...
            FileLog.e("tsupport", "write int32 error");
        }
    }
    ...
    private void writeInt64(long x, DataOutputStream out) {
        try {
            ...
            FileLog.e("tsupport", "write int64 error");
        }
    }
    ...
    public boolean readBool() {
        ...
        FileLog.e("tsupport", "Not bool value!");
        return false;
    }
    ...
    public int readInt32(boolean[] error) {
        try {
            ...
            FileLog.e("tsupport", "read int32 error");
        }
        return 0;
    }
    ...
    public long readInt64(boolean[] error) {
        try {
            ...
            FileLog.e("tsupport", "read int64 error");
        }
        return 0;
    }
    ...
    public void writeRaw(byte[] b) {
        try {
            ...
            FileLog.e("tsupport", "write raw error");
        }
    }
    ...
    public void writeByte(int i) {
        try {
            ...
            FileLog.e("tsupport", "write byte error");
        }
    }
    ...
    public void readRaw(byte[] b) {
        try {
            ...
            FileLog.e("tsupport", "read raw error");
        }
    }
    ...
    public String readString() {
        try {
            ...
            FileLog.e("tsupport", "read string error");
        }
        return null;
    }
    ...
    public byte[] readByteArray() {
        try {
            ...
            FileLog.e("tsupport", "read byte array error");
        }
        return null;
    }
    ...
    public void writeByteArray(byte[] b) {
        try {
            ...
            FileLog.e("tsupport", "write byte array error");
        }
    }
    ...
    public void writeString(String s) {
        try {
            ...
            FileLog.e("tsupport", "write string error");
        }
    }
    ...
    public double readDouble() {
        try {
            ...
            FileLog.e("tsupport", "read double error");
        }
        return 0;
    }
    ...
    public void writeDouble(double d) {
        try {
            ...
            FileLog.e("tsupport", "write double error");
        }
    }
