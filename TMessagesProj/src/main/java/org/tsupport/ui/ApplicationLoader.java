...
public class ApplicationLoader extends Application {
    ...
    public static void postInitApplication() {
        ...
        try {
            ...
            FileLog.e("tsupport", "screen state = " + isScreenOn);
        } catch (Exception e) {
...
//                alarm.setRepeating(AlarmManager.RTC_WAKEUP, cal.getTimeInMillis(), 30000, pintent);
    ...
    private void initPlayServices() {
        if (checkPlayServices()) {
            ...
            FileLog.d("tsupport", "No valid Google Play Services APK found.");
        }
    }
    ...
    private boolean checkPlayServices() {
        ...
        /*if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                ...
                Log.i("tsupport", "This device is not supported.");
            }
            return false;
        }
        return true;*/
    ...
    private String getRegistrationId() {
        ...
        if (registrationId.length() == 0) {
            FileLog.d("tsupport", "Registration not found.");
            return "";
        }
        int registeredVersion = prefs.getInt(PROPERTY_APP_VERSION, Integer.MIN_VALUE);
        int currentVersion = getAppVersion();
        if (registeredVersion != currentVersion) {
            FileLog.d("tsupport", "App version changed.");
            return "";
        }
    ...
    private void storeRegistrationId(Context context, String regId) {
        ...
        FileLog.e("tsupport", "Saving regId on app version " + appVersion);
