    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (intent.getAction().equals("com.google.android.c2dm.intent.RECEIVE")) {
            ...
            if (intent.getStringExtra("error") != null) {
                FileLog.e("tsupport", "Registration failed, should try again later.");
            } else if (intent.getStringExtra("unregistered") != null) {
                FileLog.e("tsupport", "unregistration done, new messages from the authorized sender will be rejected");
            } else if (registration != null) {
                FileLog.e("tsupport", "registration id = " + registration);
            }
        }
