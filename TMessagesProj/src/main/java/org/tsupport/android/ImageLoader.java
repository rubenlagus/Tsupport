...
public class ImageLoader {
    ...
    public ImageLoader() {
        ...
        BroadcastReceiver receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context arg0, Intent intent) {
                FileLog.e("tsupport", "file system changed");
    ...
    private HashMap<Integer, File> createMediaPaths() {
        ...
        FileLog.e("tsupport", "cache path = " + cachePath);

        try {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                telegramPath = new File(Environment.getExternalStorageDirectory(), "Tsupport");
                telegramPath.mkdirs();
                ...
                if (canRename) {
                    if (telegramPath.isDirectory()) {
                        try {
                            ...
                            if (imagePath.isDirectory()) {
                                ...
                                FileLog.e("tsupport", "image path = " + imagePath);
                            }
                        } catch (Exception e) {
                            FileLog.e("tsupport", e);
                        }
                        ...
                        try {
                            ...
                            if (videoPath.isDirectory()) {
                                ...
                                FileLog.e("tsupport", "video path = " + videoPath);
                            }
                        } catch (Exception e) {
                            FileLog.e("tsupport", e);
                        }
                        ...
                        try {
                            File audioPath = new File(telegramPath, "Tsupport Audio");
                            audioPath.mkdir();
                            if (audioPath.isDirectory()) {
                                new File(audioPath, ".nomedia").createNewFile();
                                mediaDirs.put(FileLoader.MEDIA_DIR_AUDIO, audioPath);
                                FileLog.e("tsupport", "audio path = " + audioPath);
                            }
                        } catch (Exception e) {
                            FileLog.e("tsupport", e);
                        }
                        ...
                        try {
                            File documentPath = new File(telegramPath, "Tsupport Documents");
                            documentPath.mkdir();
                            if (documentPath.isDirectory()) {
                                new File(documentPath, ".nomedia").createNewFile();
                                mediaDirs.put(FileLoader.MEDIA_DIR_DOCUMENT, documentPath);
                                FileLog.e("tsupport", "documents path = " + documentPath);
                            }
                        } catch (Exception e) {
                            FileLog.e("tsupport", e);
                        }
                    ...
                    FileLog.e("tsupport", "this Android can't rename files");
                }
            }
